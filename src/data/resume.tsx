...
export const DATA = {
  ...
  work: [
    ...
    },
    {
      ...
      href:"https://www.cavisson.com",
      badges: [],
      location: "Noida",
      title: "Associate Software Developer",
      logoUrl: " https://www.cavisson.com/wp-content/themes/onetone/images/logo/logo_original.png",
      start: "May 2025",
      end: "Present ",
      description:
        "Worked on multiple projects at Cavisson Systems using React, React Native, and Node.js. Gained hands-on experience in full-stack development, API integration, and performance optimization for enterprise monitoring tools.",
    },
  ...
  projects: [
    ...
    },
    {
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/sandeepyadav-24/Explr",
          icon: <Icons.github className="size-3" />,
        },
      ],
      image: "/aiplanner.png",
